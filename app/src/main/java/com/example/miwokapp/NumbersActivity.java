...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // creating an audio manager to get audio focus
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Word word= words.get(i); // i is position

                // releasing the media player resources before starting to play a different audio
                releaseMediaPlayer();
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(NumbersActivity.this,word.getMediaId());
                    mMediaPlayer.start();
    ...
    private void releaseMediaPlayer() {
        ...
        if (mMediaPlayer != null) {
            ...
            // abandoning the audio focus when playback is completed
